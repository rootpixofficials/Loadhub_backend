...
export const createDriverVehicle = async (req, res) => {
    try {
        let { driver_id, vehicle_type_id, registration_number, vehicle_model, insurance_valid_until, per_km_rate, status, basic_location, basic_latitude, basic_longitude } = req.body;
        ...
        const newVehicle = await addDriverVehicle({
            ...
            per_km_rate, status, basic_location, basic_latitude, basic_longitude
        });
...
export const editDriverVehicle = async (req, res) => {
    try {
        const { id } = req.params;
        let { vehicle_type_id, registration_number, vehicle_model, insurance_valid_until, status, per_km_rate, basic_location, basic_latitude, basic_longitude } = req.body;
